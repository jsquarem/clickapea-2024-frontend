// src/components/ImageUploadModal/ImageUploadModal.js
          ...
          >
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className={`${selectedFiles.length === 0 ? 'bg-gray-400' : 'bg-blue-500 hover:bg-blue-700'} text-white font-bold py-2 px-4 rounded`}
              >
                Upload
              </button>
            </div>
