  ...
  return (
    <div className="relative group">
      <button
        ...
        className={`font-bold py-2 px-4 rounded inline-flex items-center text-white ${isAuthenticated ? 'bg-orange-500 hover:bg-orange-700' : 'bg-gray-500 cursor-not-allowed'}`}
      >
